...
public class GRN extends javax.swing.JFrame {
    ...
    private void btn_save1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        model.GRN grn = new model.GRN();
        grn.setProductId(selectedProductId);
        grn.setSupplierId(supplierId);
        try {
            grn.setOrderedQuantity(Integer.parseInt(Ordered_Qty.getText().trim()));
            grn.setDeliveredQuantity(Integer.parseInt(Delivered_Quantity.getText().trim()));
        ...
        String result = grnController.addGRN(grn);
    ...
    private void btn_delete1ActionPerformed(java.awt.event.ActionEvent evt) {
        if (selectedGrnId <= 0) {
            JOptionPane.showMessageDialog(this, "Please select a GRN to delete!", "Selection Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void btn_update1ActionPerformed(java.awt.event.ActionEvent evt) {
        if (selectedGrnId <= 0) {
            JOptionPane.showMessageDialog(this, "Please select a GRN to update!", "Selection Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        // 2. Pass to Controller
        String result = grnController.updateGRN(grn);
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (dateStr.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please select a date first!", "Input Missing",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
