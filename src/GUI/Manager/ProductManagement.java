 ...
 * This class handles adding, updating, and deleting products in the system.
 */
package GUI.Manager;
...
/**
 * Screen for managing items/products.
 * Follows MVC architecture using ProductController.
 */
public class ProductManagement extends javax.swing.JFrame {

        private ProductController controller;
        private int selectedProductId = -1; // ID of the product currently selected in the table
        private Map<String, Integer> categoryMap = new HashMap<>(); // Maps category names to IDs

        public ProductManagement() {
                initComponents();
                controller = new ProductController();
                this.setExtendedState(javax.swing.JFrame.MAXIMIZED_BOTH);
                loadCategories(); // Fill the category dropdown
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item_ID", "Item_Name", "Category", "Buying_Price ", "Item_Price"
            }
        ) {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbl_6)
                    .addComponent(txt_BuyingPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lbl_4))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(lbl_6)
                .addGap(7, 7, 7)
                .addComponent(txt_BuyingPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        private void txt_itemsearchKeyReleased(java.awt.event.KeyEvent evt) {
                searchProduct();
        }

        private void btn_supplierActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (selectedRow >= 0) {
                        // Populate fields with current selection
                        ...
                        String buyingPrice = jTable1.getValueAt(selectedRow, 3).toString();
        ...
        /**
         * Loads available categories into the dropdown menu.
         */
        private void loadCategories() {
                ...
                for (Category cat : categories) {
                        cmb_Category.addItem(cat.getCategoryName());
        ...
        /**
         * Loads all products into the table view.
         */
        ...
        private void updateProduct() {
                if (selectedProductId == -1) {
                        JOptionPane.showMessageDialog(this, "Please select a product to update.", "Selection Error",
        ...
        private void searchProduct() {
                String term = txt_itemsearch.getText().trim();
                List<Product> products = controller.searchProducts(term);
        ...
        /**
         * Clears all fields and resets selection state.
         */
        ...
        public static void main(String args[]) {
                try {
                        ...
                        java.util.logging.Logger.getLogger(ProductManagement.class.getName())
