package GUIComponents.DateChooser;
...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new GUIComponents.DateChooser.Button();
        cmdTu = new GUIComponents.DateChooser.Button();
        cmdWe = new GUIComponents.DateChooser.Button();
        cmdTh = new GUIComponents.DateChooser.Button();
        cmdFr = new GUIComponents.DateChooser.Button();
        cmdSa = new GUIComponents.DateChooser.Button();
        cmdSu = new GUIComponents.DateChooser.Button();
        cmd1 = new GUIComponents.DateChooser.Button();
        cmd2 = new GUIComponents.DateChooser.Button();
        cmd3 = new GUIComponents.DateChooser.Button();
        cmd4 = new GUIComponents.DateChooser.Button();
        cmd5 = new GUIComponents.DateChooser.Button();
        cmd6 = new GUIComponents.DateChooser.Button();
        cmd7 = new GUIComponents.DateChooser.Button();
        cmd8 = new GUIComponents.DateChooser.Button();
        cmd9 = new GUIComponents.DateChooser.Button();
        cmd10 = new GUIComponents.DateChooser.Button();
        cmd11 = new GUIComponents.DateChooser.Button();
        cmd12 = new GUIComponents.DateChooser.Button();
        cmd13 = new GUIComponents.DateChooser.Button();
        cmd14 = new GUIComponents.DateChooser.Button();
        cmd15 = new GUIComponents.DateChooser.Button();
        cmd16 = new GUIComponents.DateChooser.Button();
        cmd17 = new GUIComponents.DateChooser.Button();
        cmd18 = new GUIComponents.DateChooser.Button();
        cmd19 = new GUIComponents.DateChooser.Button();
        cmd20 = new GUIComponents.DateChooser.Button();
        cmd21 = new GUIComponents.DateChooser.Button();
        cmd22 = new GUIComponents.DateChooser.Button();
        cmd23 = new GUIComponents.DateChooser.Button();
        cmd24 = new GUIComponents.DateChooser.Button();
        cmd25 = new GUIComponents.DateChooser.Button();
        cmd26 = new GUIComponents.DateChooser.Button();
        cmd27 = new GUIComponents.DateChooser.Button();
        cmd28 = new GUIComponents.DateChooser.Button();
        cmd29 = new GUIComponents.DateChooser.Button();
        cmd30 = new GUIComponents.DateChooser.Button();
        cmd31 = new GUIComponents.DateChooser.Button();
        cmd32 = new GUIComponents.DateChooser.Button();
        cmd33 = new GUIComponents.DateChooser.Button();
        cmd34 = new GUIComponents.DateChooser.Button();
        cmd35 = new GUIComponents.DateChooser.Button();
        cmd36 = new GUIComponents.DateChooser.Button();
        cmd37 = new GUIComponents.DateChooser.Button();
        cmd38 = new GUIComponents.DateChooser.Button();
        cmd39 = new GUIComponents.DateChooser.Button();
        cmd40 = new GUIComponents.DateChooser.Button();
        cmd41 = new GUIComponents.DateChooser.Button();
        cmd42 = new GUIComponents.DateChooser.Button();
    ...
    private GUIComponents.DateChooser.Button cmd1;
    private GUIComponents.DateChooser.Button cmd10;
    private GUIComponents.DateChooser.Button cmd11;
    private GUIComponents.DateChooser.Button cmd12;
    private GUIComponents.DateChooser.Button cmd13;
    private GUIComponents.DateChooser.Button cmd14;
    private GUIComponents.DateChooser.Button cmd15;
    private GUIComponents.DateChooser.Button cmd16;
    private GUIComponents.DateChooser.Button cmd17;
    private GUIComponents.DateChooser.Button cmd18;
    private GUIComponents.DateChooser.Button cmd19;
    private GUIComponents.DateChooser.Button cmd2;
    private GUIComponents.DateChooser.Button cmd20;
    private GUIComponents.DateChooser.Button cmd21;
    private GUIComponents.DateChooser.Button cmd22;
    private GUIComponents.DateChooser.Button cmd23;
    private GUIComponents.DateChooser.Button cmd24;
    private GUIComponents.DateChooser.Button cmd25;
    private GUIComponents.DateChooser.Button cmd26;
    private GUIComponents.DateChooser.Button cmd27;
    private GUIComponents.DateChooser.Button cmd28;
    private GUIComponents.DateChooser.Button cmd29;
    private GUIComponents.DateChooser.Button cmd3;
    private GUIComponents.DateChooser.Button cmd30;
    private GUIComponents.DateChooser.Button cmd31;
    private GUIComponents.DateChooser.Button cmd32;
    private GUIComponents.DateChooser.Button cmd33;
    private GUIComponents.DateChooser.Button cmd34;
    private GUIComponents.DateChooser.Button cmd35;
    private GUIComponents.DateChooser.Button cmd36;
    private GUIComponents.DateChooser.Button cmd37;
    private GUIComponents.DateChooser.Button cmd38;
    private GUIComponents.DateChooser.Button cmd39;
    private GUIComponents.DateChooser.Button cmd4;
    private GUIComponents.DateChooser.Button cmd40;
    private GUIComponents.DateChooser.Button cmd41;
    private GUIComponents.DateChooser.Button cmd42;
    private GUIComponents.DateChooser.Button cmd5;
    private GUIComponents.DateChooser.Button cmd6;
    private GUIComponents.DateChooser.Button cmd7;
    private GUIComponents.DateChooser.Button cmd8;
    private GUIComponents.DateChooser.Button cmd9;
    private GUIComponents.DateChooser.Button cmdFr;
    private GUIComponents.DateChooser.Button cmdMo;
    private GUIComponents.DateChooser.Button cmdSa;
    private GUIComponents.DateChooser.Button cmdSu;
    private GUIComponents.DateChooser.Button cmdTh;
    private GUIComponents.DateChooser.Button cmdTu;
    private GUIComponents.DateChooser.Button cmdWe;
