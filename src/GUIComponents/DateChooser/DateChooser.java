...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new GUIComponents.DateChooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new GUIComponents.DateChooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new GUIComponents.DateChooser.Button();
        cmdPrevious = new GUIComponents.DateChooser.Button();
        slide = new GUIComponents.DateChooser.Slider();
    ...
    private GUIComponents.DateChooser.Button cmdForward;
    private GUIComponents.DateChooser.Button cmdMonth;
    private GUIComponents.DateChooser.Button cmdPrevious;
    private GUIComponents.DateChooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private GUIComponents.DateChooser.Slider slide;
